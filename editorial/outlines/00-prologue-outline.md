...
**DNA Structure:** Story-heavy (this IS the hook)
...
- "This wasn't organized the way I expected"
- "There's something here I can't explain with my existing map"
...
- The Ring (named in Ch 1)
- Scale Errors (explained in Ch 1)
- Four Habitats (named in Ch 1, deep-dived in Ch 3-6)
- Hybrids (returned to in Ch 7)
- Category Error (examined in Ch 8)

---

**END OF PROLOGUE OUTLINE**

*Next: Chapter 1 Outline (One Size Fits None)*
